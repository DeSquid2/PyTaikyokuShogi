...
# # Creates a chess piece class that shows what team a piece is on, what type of piece it is and whether or not it
# can be killed by another selected piece.
class Piece:
...
"""
This is creating the nodes that are on the board(so the chess tiles)
